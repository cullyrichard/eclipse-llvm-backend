...
unsigned int results_addr = 0100;
...
//const unsigned int *fpu_md_ptr = fpu_md;
...
int main(void) {
    ...
    load_md(01000,FPU_MD_LEN,fpu_md);
    ...
    //fps_output_word = read_md(results_addr);
    ...
    for(int word_iterator = 01001; word_iterator<01006; word_iterator++){
        fps_output_word = read_md(word_iterator);
